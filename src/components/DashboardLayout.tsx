...
const DashboardLayout = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/dashboard/notifications") markAllAsRead();
  }, [location.pathname]);
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-blue-50 to-gray-50 font-sans">
          ...
          {links.map((link) => {
            ...
            return (
              <NavLink
                ...
                className={`flex items-center space-x-4 p-3.5 rounded-xl text-base transition-all duration-250 ${
                  isActive
        ...
        <header className="flex justify-between items-center bg-white px-10 py-5 border-b border-gray-100 shadow-md">
          ...
          <div className="flex items-center space-x-6">
            <NavLink
              ...
              className="relative text-gray-500 hover:text-blue-600 p-2 rounded-full hover:bg-gray-100"
            >
            ...
            <NavLink
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 hover:bg-blue-200"
            >
              <User className="w-6 h-6 text-blue-700" />
            </NavLink>
            <button
              onClick={handleLogout}
              className="flex items-center space-x-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-5 py-2.5 rounded-full shadow-lg"
            >
